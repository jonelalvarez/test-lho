<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Departments.aspx.vb" Inherits="Departments" %>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group" >                        
                    <label>Code</label>
                    <div>
                        <input id="txt_code" maxlength="45" class="form-control required" runat="server" onchange="validateEntry(this, 'deptCode')"/>
                    </div> 
                </div> 
                ...
                <div class="form-group" >                        
                    <label>Name</label>
                    <div>
                        <input id="txt_name" maxlength="45" class="form-control required" runat="server" onchange="validateEntry(this, 'deptName')"/>
                    </div> 
                </div> 
