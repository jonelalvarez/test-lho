<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Occupancy.aspx.vb" Inherits="Occupancy" %>
            ...
            <div class="modal-header">
              ...
              <div class="modal-body">
                  <div class="form-group" >                        
                    ...
                    <div>
                        <input id="txt_Occupancy" maxlength="45" class="form-control required" runat="server" onchange="validateEntry(this, 'CategoryName')"/>
                    </div> 
                </div> 
                  <!--DL STATUS-->
