<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="LHOForms.aspx.vb" Inherits="LHOForms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="card card-success form-group">
            ...
            <div class="card-body pt-1">
                ...
                <div class="row form-group m-0 p-0">
                    ...
                    <div class="card-body form-group col-md-8 pt-3 m-0">
                        <label>Address</label>
    ...
    <script>
        ...
        function goToApplicantList() {
            ...
            window.location.href = 'Applicant.aspx';
        }
            ...
            if (obj.value != '') {
                $.ajax({
                    ...
                    success: function (a) {
                        ...
                        $('#<%=txt_contactNum.ClientID%>').val(result.contactNo);
                        ...
                        $('#<%=dl_occupancyStatus.ClientID%>').val(result.occStatus).trigger('change');
